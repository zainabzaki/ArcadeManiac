...
class scrabble(Frame):
     ...
     def compare_list(self):
          for self.btn_v in self.v: #self.v is shuffled list where k is the index no
     ...
     def clear_1(self):
          ...
          if self.pos == 0:
               ...
               self.btn_new=Button(self,text="L",bg="skyBlue", fg="Black",width=5,height=2,font=('Helvetica','20'))
               self.btn_new.grid(row=0,column=0)
          if self.pos == 1:
               
               self.btn_new=Button(self,text="L",bg="skyBlue", fg="Black",width=5,height=2,font=('Helvetica','20'))
               self.btn_new.grid(row=0,column=1)
     ...
     def button(self):
          ...
          dict={self.btn1:"A",self.btn2:"R",self.btn3:"B",self.btn4:"Z",self.btn5:"T",self.btn6:"D",self.btn7:"H",self.btn8:"M",self.btn9:"V",self.btn10:"S"
